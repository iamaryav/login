...
<body>
	...
	try{
		...
		<div align="center">
		<h1>Welcome  ${username}</h1></h1><br>
	
		<form action="Logout">
			<label>Username</label><input type="text" name="uname" value="<%= unames %>" readonly/><br /><br/>
			<label>Password </label><input type="password" name="pass" value="<%= pass %>" readonly/><br/><br/>
			<label>Employer </label><input type="text" name="emp" value="<%= emp %>" readonly/><br /><br/>
			<label>Address</label>&nbsp;<textarea name="address" rows="2" cols="25" readonly><%= add %></textarea><br /><br/>
